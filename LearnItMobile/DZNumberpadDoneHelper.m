...
- (void)keyboardWillShow:(NSNotification*)note
{
    ...
    // iPhone5 fix by vladkorotnev
    CGRect startFrame = CGRectMake(-3.0f, (screenSize.height-53) + CGRectGetHeight(keyboardFrame), 108.0f, 53.0f);
	CGRect fixedFrame = CGRectMake(-3.0f, (screenSize.height-53), 108.0f, 53.0f);
